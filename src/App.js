...
import { TextInput, Button, Card, Col, Row } from "react-materialize";
import "./App.css";

const female = {
  duration: 1,
  background:
    "linear-gradient(to bottom right, rgb(205, 37, 207), rgb(256, 13, 175))",
...
const male = {
  duration: 1,
  background:
    "linear-gradient(to bottom right, rgb(65, 77, 247), rgb(56, 103, 255))",
  border: "solid 2px #2B2D41",
  color: "white"
};
...
class App extends Component {
  ...
  handleSubmit = e => {
    ...
    const weightCalculation = state.weight;
    const heightCalc = state.feet;
  ...
  render() {
    ...
    return (
      <div className="container-App">
        <div className="App">
          <h1 className="title-of-app">Indice Massa Muscular</h1>
